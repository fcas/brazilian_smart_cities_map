...
function getTweetMean()
{
    ...
    // true for asynchronous
    xmlHttp.open("GET", "https://www.googleapis.com/fusiontables/v2/query?sql=SELECT%20'_tweetCreatedAt_mean'%20FROM%201PqEmJaVBttvyI8Vsf-uJiUwZjAMSh453MlAkp_Nr&key=AIzaSyDwUfVAwBI1D230DuY1QwsqHaKamdJlMI8", true);
    xmlHttp.send(null)
}
...
function getResponseTimeMean()
{
    ...
    // true for asynchronous
    xmlHttp.open("GET", "https://www.googleapis.com/fusiontables/v2/query?sql=SELECT%20'_responseTime_mean'%20FROM%201PqEmJaVBttvyI8Vsf-uJiUwZjAMSh453MlAkp_Nr&key=AIzaSyDwUfVAwBI1D230DuY1QwsqHaKamdJlMI8", true);
    xmlHttp.send(null)
}
...
function getFavoritesMean()
{
    ...
    // true for asynchronous
    xmlHttp.open("GET", "https://www.googleapis.com/fusiontables/v2/query?sql=SELECT%20'_favorites_mean'%20FROM%201PqEmJaVBttvyI8Vsf-uJiUwZjAMSh453MlAkp_Nr&key=AIzaSyDwUfVAwBI1D230DuY1QwsqHaKamdJlMI8", true);
    xmlHttp.send(null)
}
...
function getRepliesMean()
{
    ...
    // true for asynchronous
    xmlHttp.open("GET", "https://www.googleapis.com/fusiontables/v2/query?sql=SELECT%20'_inReplyToStatusId_mean'%20FROM%201PqEmJaVBttvyI8Vsf-uJiUwZjAMSh453MlAkp_Nr&key=AIzaSyDwUfVAwBI1D230DuY1QwsqHaKamdJlMI8", true);
    xmlHttp.send(null)
}
...
function getRetweetsMean()
{
    ...
    // true for asynchronous
    xmlHttp.open("GET", "https://www.googleapis.com/fusiontables/v2/query?sql=SELECT%20'_retweets_mean'%20FROM%201PqEmJaVBttvyI8Vsf-uJiUwZjAMSh453MlAkp_Nr&key=AIzaSyDwUfVAwBI1D230DuY1QwsqHaKamdJlMI8", true);
    xmlHttp.send(null)
}
...
function getMentionsMean()
{
    ...
    // true for asynchronous
    xmlHttp.open("GET", "https://www.googleapis.com/fusiontables/v2/query?sql=SELECT%20'_tweetCreatedAt_mention_mean'%20FROM%201PqEmJaVBttvyI8Vsf-uJiUwZjAMSh453MlAkp_Nr&key=AIzaSyDwUfVAwBI1D230DuY1QwsqHaKamdJlMI8", true);
    xmlHttp.send(null)
}
